...
func _init() -> void:
	...
	render_pose.get_output_tag("RENDER_DATA").connect_to(annotation.get_input_index(0), "pose_landmarks_render_data")
	render_hand_left.get_output_tag("RENDER_DATA").connect_to(annotation.get_input_index(1), "left_hand_landmarks_render_data")
	render_hand_right.get_output_tag("RENDER_DATA").connect_to(annotation.get_input_index(2), "right_hand_landmarks_render_data")
